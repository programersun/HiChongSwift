//
//  ICYMultiImageGreenCircle.swift
//  MultiImageTest
//
//  Created by eagle on 15/1/26.
//  Copyright (c) 2015年 Li Chaoyi. All rights reserved.
//

import UIKit

class ICYMultiImageGreenCircle: UIView {
    ...
    override init(frame: CGRect) {
        ...
        // 圆圈背景
        let circleImageView = UIImageView(image: UIImage(named: ICYMultiImageGreenCircleImage))
