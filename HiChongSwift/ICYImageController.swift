...
class ICYImageController: UIViewController {
    ...
    private var mainScroll: ICYImageScrollView = ICYImageScrollView(frame: CGRectZero)
...
extension ICYImageController: UIScrollViewDelegate {
